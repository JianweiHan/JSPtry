  ...
  <div class="container">
    <div id="searchBar">
      ...
      <div class="content">
        <form action="#" method="post">
          <input name="search_button" type="" class="button" src="images/search.gif" />
          <input type="text" name="search" class="search" />
        </form>
      </div>
    </div>
    <div class="icon"> <img src="images/hand_logo.gif" width="200" height="160"
                            alt="" /> </div>
    <div id="title">
      <h1> LWM2M EXAMPLE </h1>
      <h2> IoT is coming... </h2>
    ...
    <div id="navigation">
      <ul>
        ...
        <li><a href="http://localhost:8080/JSPtry_war_exploded/hello/map">Client</a></li>
    ...
    <div id="body">
      ...
      <div class="content">
        <h3> <a href="http://all-free-download.com/free-website-templates/">Happy New Year</a></h3>
        <div class="byline">By Aaron Ganschow, January 2, 2007 </div>
        <p>The design started with a very simple idea, and with help from some close friends, I have completed a somewhat comprehensive design in a surprisingly short amount of time. I have some hesitations as well as some shining pride for this design. Some of my ideas for this design are discussed in the <a href="design.html">design section</a>, as well as some explanation of how it works. Please take the time to review what I ahve written so that you can use this design to its fullest potential in your website.</p>
